...
//         <Link  className={classes.text} to="/home"> Home </Link>
//       </button>
//       <button className={classes.button}>
//         <Link className={classes.text} to="/profile"> Profile </Link>
//       </button>
//       <button className={classes.button}>
//         <Link className={classes.text} to="/notification"> Notification </Link>
//       </button>
...
//         <button className={classes.button}>
//              <Link className={classes.text} to="/logout"> Logout </Link>
//         </button>
